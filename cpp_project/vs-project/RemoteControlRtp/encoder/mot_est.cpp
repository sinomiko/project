			    ...
			    int pixels_on_line, int Min_SAD)
{
  ...
  while(j--) {
    ...
    sad += abs((int)(*(ii + 2)-(*(curr+1))));
	sad += abs((int)(*(ii + 4)-(*(curr+2))));
	sad += abs((int)(*(ii + 6)-(*(curr+3))));
    sad += abs((int)(*(ii + 8)-(*(curr+4))));
    sad += abs((int)(*(ii + 10)-(*(curr+5))));
    sad += abs((int)(*(ii + 12)-(*(curr+6))));
    sad += abs((int)(*(ii + 14)-(*(curr+7))));
    sad += abs((int)(*(ii + 16)-(*(curr+8))));
    sad += abs((int)(*(ii + 18)-(*(curr+9))));
    sad += abs((int)(*(ii + 20)-(*(curr+10))));
    sad += abs((int)(*(ii + 22)-(*(curr+11))));
    sad += abs((int)(*(ii + 24)-(*(curr+12))));
    sad += abs((int)(*(ii + 26)-(*(curr+13))));
    sad += abs((int)(*(ii + 28)-(*(curr+14))));
    sad += abs((int)(*(ii + 30)-(*(curr+15))));
